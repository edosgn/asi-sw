...
use JHWEB\DocumentoBundle\Entity\Documento;
use JHWEB\DocumentoBundle\Form\DocumentoType;
...
class DocumentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JHWEBDocumentoBundle:Documento')->findAll();
     ...
     * @Method("POST")
     * @Template("JHWEBDocumentoBundle:Documento:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JHWEBDocumentoBundle:Documento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JHWEBDocumentoBundle:Documento:edit.html.twig")
     */
