...
namespace JHWEB\GrupoBundle\Controller;
...
use JHWEB\GrupoBundle\Entity\Grupo;
use JHWEB\GrupoBundle\Form\GrupoType;
...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JHWEBGrupoBundle:Grupo')->findAll();
     ...
     * @Method("POST")
     * @Template("JHWEBGrupoBundle:Grupo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JHWEBGrupoBundle:Grupo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JHWEBGrupoBundle:Grupo:edit.html.twig")
     */
